...
S:LQ2_adc.LCD_CmdWrite$cmd$1$32({1}SC:S),R,0,0,[r7]
S:LQ2_adc.LCD_DataWrite$dat$1$34({1}SC:S),R,0,0,[]
S:LQ2_adc.LCD_StringWrite$length$1$36({1}SC:U),E,0,0
S:LQ2_adc.LCD_StringWrite$str$1$36({3}DG,SC:S),R,0,0,[r5,r6,r7]
S:LQ2_adc.sdelay$delay$1$41({2}SI:S),R,0,0,[r6,r7]
S:LQ2_adc.sdelay$d$1$42({1}SC:S),R,0,0,[r5]
...
S:FQ2_adc$__str_0$0$0({16}DA16d,SC:S),D,0,0
